        ...
        <motion.div initial={{ opacity: 0, top: "-50%", y: 0 }} animate={{ opacity: 1, y: -20, }} exit={{ opacity: 1, scale: .8, y: 0 }} transition={{ duration: 0.3 }}>
            <OpenResource_container>
                <OpenResource_links_container>
                    <OpenResource_links_cube>
                        <div>✔</div>
                        <OpenResource_link href='https://ic.pccu.edu.tw/resources/100_learningmap.pdf' target="_blank">碩士班課程學習地圖與基本能力指標下載</OpenResource_link>
                    </OpenResource_links_cube>
                    <OpenResource_links_cube>
                        <div>✔</div>
...
`
const OpenResource_links_cube = styled.div`
    display: flex;
    align-items: center;
    margin-bottom: 20px;
`
