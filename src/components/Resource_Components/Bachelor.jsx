    ...
    return (
        <motion.div initial={{ opacity: 0, top: "-50%", y: 20 }} animate={{ opacity: 1, y: 0, }} exit={{ opacity: 1, scale: .8, y: 0 }} transition={{ duration: 0.3 }}>
            ...
            <Context>
                ...
                <br />
                <br />
                2.必修：90-96學分（依入學學年而定）
                <br />
                <br />
                &emsp;&emsp; i.  必修科目表中的所有課程，包含：校共同必修32學分、院必修12學分、系必修60-64學分（依入學學年而定）<br />
                &emsp;&emsp; ii. 校共同必修包含：國文4、英文4、語實2、通識10(人文4、社會4、自然2)、軍訓0學分、跨域12
                <br />&emsp;&emsp;跨域專長介紹網站 <Link href='https://cross.pccu.edu.tw/p/404-1259-97280.php?Lang=zh-tw' target="_blank">https://cross.pccu.edu.tw/p/404-1259-97280.php?Lang=zh-tw</Link>
                <br />&emsp;&emsp;必修科目表下載：<Link href='https://cur.pccu.edu.tw/var/file/41/1041/img/166/203645860.doc' target="_blank">https://cur.pccu.edu.tw/var/file/41/1041/img/166/203645860.doc</Link><br />
                <br />
                <br />

                3. 學群選修（依入學學年而定）：選定組別後，該組須滿18學分
                <br />
                <br />
                &emsp;&emsp; i. 學群手冊下載：<Link href="https://files.pccu.edu.tw:5001/sharing/gCNPFlEBf" target="_blank">https://files.pccu.edu.tw:5001/sharing/gCNPFlEBf </Link> <br />
                &emsp;&emsp;備註：2年級下學期進行學群分組，未修課程以0分計算，請優先補修分組計分課程。
                <br />
                <br />
                4. 自由學分（依入學學年而定；14-18學分）
