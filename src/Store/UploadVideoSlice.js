...
export const PostUploadVideo = createAsyncThunk(
    'Post/UploadVideo',
    async (data) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadVideo/upload/video`, data).then((res) =>
            res.data
        )
        return result
    }
...
export const GetUploadVideo = createAsyncThunk(
    'Get/UploadVideo',
    async () => {
        let result = await axios.get(`${process.env.REACT_APP_API_URL}/api/UploadVideo/getVideo`).then((res) => {
            return res.data
        })
        return result
    }
...
export const DeleteUploadVideo = createAsyncThunk(
    'Delete/Video',
    async (data) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadVideo/DeleteVideo`, data).then(res =>
            res.data)
        return result
    }
)
