...
export const getUploadImageArray = createAsyncThunk(
    "get/UploadImage",
    async () => {
        let data = await axios.get("http://140.137.51.13:3003/api/uploadImage/getImage").then((res) => {
            return res.data
        })
        return data
    }
...
export const postUploadImage = createAsyncThunk(
    "post/UploadImage",
    async (aug) => {
        let data = await axios.post("http://140.137.51.13:3003/api/uploadImage/post/image", aug).then((res) => {
            return res.data
        })
        return data
...
export const postDeleteImage = createAsyncThunk(
    "post/DeleteImage",
    async (fileName) => {
        let data = await axios.post("http://140.137.51.13:3003/api/uploadImage/delete/uploadImage", { fileName }).then((res) => {
            return res.data
        })
        return data
    }
