...
export const postAnnouncement = createAsyncThunk(
	'Post/Announcement',
	async (data) => {
		let result = await axios.post('http://140.137.51.13:3003/api/UploadAnnouncement/post/announcement', data).then(res => res.data)
		console.log(result)
		return result
...
export const updateAnnouncement = createAsyncThunk(
	'Post/Announcement',
	async (data) => {
		let result = await axios.post('http://140.137.51.13:3003/api/UploadAnnouncement/update/Announcement', data).then(res => res.data)
		console.log(result)
		return result
