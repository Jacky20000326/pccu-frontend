...
export const PostTeacherInfo = createAsyncThunk(
    'Post/TeacherInfo',
    async (teacherInfo) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTeacher/post/teacher`, teacherInfo).then(res => res.data)
        console.log(result)
        return result
    }
)
...
export const getTeacherInfo = createAsyncThunk(
    'Get/TeacherInfo',
    async () => {
        let result = await axios.get(`${process.env.REACT_APP_API_URL}/api/UploadTeacher/get/teacherInfo`).then(res => res.data)
        return result
    }
...
export const SearchTeacherInfo = createAsyncThunk(
    'Search/TeacherInfo',
    async (teacherName) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTeacher/Search/teacherInfo`, { teacherName }).then(res => res.data)
        return result
    }
)
export const UpdateTeacherInfo = createAsyncThunk(
    'Update/TeacherInfo',
    async (teacherInfo) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTeacher/update/teacherInfo`, teacherInfo).then(res => res.data)
        return result
    }
)
export const DeleteTeacherInfo = createAsyncThunk(
    'Delete/TeacherInfo',
    async (teacherName) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTeacher/delete/teacherInfo`, teacherName).then(res => res.data)
        return result
    }
)
const initialState = {
