...
export const PostTopic = createAsyncThunk(
    "Post/Topic",
    async (topicInfo) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTopic/post/topic`, topicInfo).then(res => res.data)
...
export const GetTopic = createAsyncThunk(
    "Get/Topic",
    async () => {
        let result = await axios.get(`${process.env.REACT_APP_API_URL}/api/UploadTopic/get/topic`).then(res => res.data)
...
export const GetTopicDetail = createAsyncThunk(
    "Get/TopicDetail",
    async (res) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTopic/get/topic/detail`, { title: res }).then(res => res.data)
        return result
    }
)
...
export const DeleteTopic = createAsyncThunk(
    'Delete/Topic',
    async (title) => {
        let result = await axios.post(`${process.env.REACT_APP_API_URL}/api/UploadTopic/delete/topic`, { title }).then(res => res.data)
        return result
    }
)
